...
var createNewTaskElement = function (taskString) {
  ...
  deleteButton.className = "delete todo__delete-button"; // Assign classes to the delete button
  ...
  deleteButton.appendChild(deleteButtonImg); // Append the delete icon to the delete button
